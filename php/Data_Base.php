...
class Data_Base {
    ...
    public function select_database() {
        return mysqli_select_db($this->mysqli,  $this->database)or die("No se encontro la Base de Datos");
    }
    ...
    public function close() {
        echo mysqli_close($this->mysqli)or die("No se pudo cerrar la conexion");
    }
    function getMysqli() {
        return $this->mysqli;
    }
